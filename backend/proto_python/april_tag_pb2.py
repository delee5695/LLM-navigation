...
_APRILTAGDATA_MAPPINGPHASE.fields_by_name["measurements"].message_type = (
    _APRILTAGTIMESTAMP
)
_APRILTAGDATA_MAPPINGPHASE.containing_type = _APRILTAGDATA
_APRILTAGDATA_LOCALIZATIONPHASE.fields_by_name["measurements"].message_type = (
    _APRILTAGTIMESTAMP
)
...
_APRILTAGDATA.fields_by_name["localizationPhase"].message_type = (
    _APRILTAGDATA_LOCALIZATIONPHASE
)

...
_GOOGLECLOUDANCHORDATA_MAPPINGPHASE.fields_by_name["cloudAnchorHost"].message_type = (
    _CLOUDANCHORHOST
)
...
_GOOGLECLOUDANCHORDATA.fields_by_name["mappingPhase"].message_type = (
    _GOOGLECLOUDANCHORDATA_MAPPINGPHASE
)
_GOOGLECLOUDANCHORDATA.fields_by_name["localizationPhase"].message_type = (
    _GOOGLECLOUDANCHORDATA_LOCALIZATIONPHASE
)
